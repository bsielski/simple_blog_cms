...
ActiveRecord::Schema.define(version: 20170808154946) do
  ...
  create_table "authors", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.text "description"
    t.index ["admin_id"], name: "index_authors_on_admin_id"
  end
  ...
  create_table "header_sections", force: :cascade do |t|
    t.text "content"
    t.integer "position"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "nav_sections", force: :cascade do |t|
    t.text "content"
    t.integer "position"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "sites", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["stylesheet_id"], name: "index_sites_on_stylesheet_id"
  end
  ...
  add_foreign_key "sites", "stylesheets"
end
